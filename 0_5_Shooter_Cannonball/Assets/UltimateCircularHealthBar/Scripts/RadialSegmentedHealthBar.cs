...
namespace RengeGames.HealthBars {
    ...
    public class RadialSegmentedHealthBar : MonoBehaviour, ISegmentedHealthBar {
        ...
        public ShaderProperty<AnimationCurve> VariableWidthCurve { get; private set; }
        ...
        [SerializeField] private AnimationCurve _variableWidthCurve = new AnimationCurve();
        ...
        private static string BaseMaterialName {
            get {
                if (GraphicsSettings.renderPipelineAsset && Int32.Parse(Application.unityVersion.Split('.')[0]) > 2019)
        ...
        private void InitProperties() {
            properties = new SortedDictionary<string, IShaderProperty>{
                ...
                ["VariableWidthCurve"] = VariableWidthCurve = new ShaderProperty<AnimationCurve>("_VariableWidthCurve", CurvePropertyFunc, _variableWidthCurve)
            };
        }
        ...
        public void ResetSerializedProperties() {
            ...
            _variableWidthCurve = new AnimationCurve(new[]{new Keyframe(0,1)});
        ...
        void ResetMaterialWithSerializedFields(bool ignoreDirty) {
            ...
            VariableWidthCurve.ApplyValueToShader(ignoreDirty, ref _variableWidthCurve);
        }
